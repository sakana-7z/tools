package src.main.java.com.sakana;
...
public class FileMerger {
    public static void main(String[] args) {
        ...
        String alternativeImagePath = "images/ciallo.jpg";
        ...
        if (parentPath != null) {
            outputImagePath = parentPath.toString() + File.separator + folderName + ".jpg";
        } else {
            System.err.println("无法获取输入文件夹的父路径。");
            return;
        }
        // 创建临时ZIP文件
